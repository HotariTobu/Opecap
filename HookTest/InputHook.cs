...
namespace HookTest
{
    public class InputHook : IDisposable
    {
        ...
        private IntPtr KeyboardProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            KeyHookEventArgs args = new KeyHookEventArgs(key, keyNameBuffer.ToString(), unicodeBuffer.ToString());
    ...
    {
        public KeyHookEventArgs(Key key, string keyName, string unicode)
        {
            Key = key;
            KeyName = keyName;
            Unicode = unicode;
